...
* The original package name 'com.minibank.mini-bank' is invalid and this project uses 'com.minibank.minibank' instead.
...
* [Liquibase Migration](https://docs.spring.io/spring-boot/docs/2.7.11/reference/htmlsingle/#howto.data-initialization.migration-tool.liquibase)
